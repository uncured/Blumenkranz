//! Project version number for BlumenkranzFramework.
FOUNDATION_EXPORT double BlumenkranzFrameworkVersionNumber;

//! Project version string for BlumenkranzFramework.
